...
const Header = () => {
  ...
  return (
    <div className="flex p-[2vh_5%] w-full border-b-[#0000001A] border-b justify-between m-[0_auto] items-center">
      ...
      <button className="block sm:hidden" onClick={toggleDrawer(true)}>
        <MenuDes />
      </button>
      <h1 className="block mr-auto ml-4 text-2xl font-bold sm:hidden">
        Exlusive
      </h1>
      <Drawer open={open} onClose={toggleDrawer(false)}>
        <div className="flex flex-col gap-[2vh] bg-white items-start p-[2vh_60px_2vh_40px]">
          ...
          <Link
            ...
            className={
              location.pathname == "/"
                ? "font-semibold border-b-2 border-b-[#0000001A]"
                : "font-semibold hover:border-b-2 hover:border-b-[#0000001A]"
            }
            to="/"
          >
            Home
      ...
      <aside className="hidden sm:flex gap-10 items-center font-semibold">
        <Link
          className={
            location.pathname == "/"
              ? "border-b-2 border-b-[#0000001A]"
              : "hover:border-b-2 hover:border-b-[#0000001A]"
          }
          to="/"
        >
          Home
      ...
      <aside className="flex gap-10 items-center font-semibold">
        ...
        {token && (
          <button
            ...
            className={
              openMenu
                ? "cursor-pointer text-white bg-[#DB4444] p-3 rounded-4xl"
                : "cursor-pointer text-black p-3 rounded-4xl"
            }
          >
            <User />
          </button>
        ...
        >
          ...
          <div className="block sm:hidden">
            <MenuItem
              className="hidden gap-6 items-center"
              onClick={() => {
                navigation("/wishlist");
                handleClose();
              }}
