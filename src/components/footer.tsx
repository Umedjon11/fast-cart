...
const Footer = () => {
  ...
  return (
    <footer className='bg-black p-[5vh_5%] mt-[15vh] flex text-white justify-between flex-wrap gap-y-[5vh]'>
        <aside className='flex flex-col gap-[3vh]'>
            ...
            <div className='border-2 border-white rounded-xl flex gap-4 p-[2vh_15px]'>
                <input className='outline-0' placeholder='Enter your email' />
                <SendHorizontal />
            </div>
        </aside>
        ...
        <p className='w-full text-[#ffffff35] font-semibold text-center'>Copyright Rimel 2022. All right reserved</p>
    </footer>
  )
}
